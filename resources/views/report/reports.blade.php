        ...
        methods:{
            ...
            _buildCalendar: function() {
                ...
                for (var i=1; i <= lastDate.getDate(); i++) { 
                    ...
                    html += '<div class="cal-value">' + this.ServiceReportCnt[i].PlacementQty + '</div>'
                    html += '</div>'
                    html += '<div class="cal-item">'
                    html += '<div class="cal-label">동영상</div>'
                    html += '<i class="fas fa-video"></i>'
                    html += '<div class="cal-value">' + this.ServiceReportCnt[i].VideoShowQty + '</div>'
                    html += '</div>'
                    html += '<div class="cal-item">'
                    html += '<div class="cal-label">방문요청</div>'
                    html += '<i class="fas fa-edit"></i>'
                    html += '<div class="cal-value">' + this.ServiceReportCnt[i].VisitRequestQty + '</div>'
                    html += '</div>'
