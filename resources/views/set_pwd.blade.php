                                    ...
                                    <form>
                                        ...
                                        <div class="input-area">
                                            <div class="input-flex-group">
                                                <input type="password" id="user_pw" class="form-control is-valid" placeholder="사용하실 비밀번호를 입력해 주세요">
                                                <label for="user_pw">사용자 비밀번호</label>
                                            ...
                                            <div class="input-flex-group">
                                                <input type="password" id="user_pw_re" class="form-control is-invalid" placeholder="비밀번호를 다시 입력해 주세요">
                                                <label for="user_pw_re">비밀번호 재입력</label>
